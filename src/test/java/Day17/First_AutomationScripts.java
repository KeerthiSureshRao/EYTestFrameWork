...
public class First_AutomationScripts {
...
//        Launch the application on Firefox browser
        ...
        driver.get(PropertiesFiles.getConfigValue(PropertiesFiles.getConfigValue("env")));//env gives current environment from .properties file
